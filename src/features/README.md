...
The key difference between preprocessors and processors is each 'side' in ShrinkImg can process differently, whereas a preprocessor happens to both sides.
