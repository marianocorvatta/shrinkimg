...
export const siteOrigin = (() => {
  ...
  if (process.env.CONTEXT === 'production') return 'https://shrinkimg.com';
  if (process.env.DEPLOY_PRIME_URL) return process.env.DEPLOY_PRIME_URL;
  console.warn(
    'Unable to determine site origin, defaulting to https://shrinkimg.com',
  );
  return 'https://shrinkimg.com';
})();
