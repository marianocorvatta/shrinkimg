...
const TermsContentEn: FunctionalComponent = () => (
  <Fragment>
    ...
    <p>
      By accessing and using ShrinkImg ("the Service"), you agree to be bound by
    ...
    <p>
      ShrinkImg is a free, browser-based image compression and conversion tool.
      All image processing occurs locally on your device. The Service is
    ...
    <h2>No Guarantees</h2>
    <p>
      While we strive to provide a reliable and high-quality service, we make no
    ...
    <p>
      You are solely responsible for the images you process using ShrinkImg. You
      must ensure you have the right to use and modify any images you compress.
      Always keep backup copies of your original images.
    </p>

    <h2>Limitation of Liability</h2>
    <p>
      To the maximum extent permitted by law, ShrinkImg and its operators shall
    ...
    <p>
      ...
      any part thereof) at any time, with or without notice. We shall not be
      liable to you or any third party for any such modification, suspension, or
      discontinuation.
    </p>
    ...
    <p>
      ...
      with the laws of the Argentine Republic. Any disputes arising from the use
      of this Service shall be subject to the jurisdiction of the courts of the
